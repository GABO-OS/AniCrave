<?php
include 'connect.php';
$anime = getAnimeByTitle($con, "Jujutsu Kaisen 2nd Season");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Jujutsu Kaisen 2nd Season - AniCrave</title>
...
<body>
    ...
    <div class="details-banner"
        style="background-image: url('<?php echo $anime['banner_image'] ?? 'img/jjk-banner.jpg'; ?>');">
    ...
    <div class="container details-header-container">
        <div class="details-cover">
            <img src="<?php echo $anime['cover_image'] ?? 'img/jjk.jpg'; ?>"
                alt="JJK Cover">
        ...
        <div class="details-title-section">
            ...
            <p class="breadcrumbs">Jujutsu Kaisen 2</p>
            <p class="description-text">
                The second season of Jujutsu Kaisen covers two major arcs: "Hidden Inventory" and "Shibuya Incident." It
                begins by exploring Gojo Satoru and Geto Suguru's past as students at Jujutsu High, and the tragic
                events that led to their divergence.
                <br><br>
                Then, it transitions into the present day for the "Shibuya Incident," where a massive curse-fueled
                conspiracy unfolds in the heart of Tokyo. Itadori Yuuji and his fellow sorcerers are thrown into a
                battle of unprecedented scale, where the stakes are higher than ever before.
            </p>
        </div>
    </div>
        ...
        <div class="details-sidebar">
            <div class="info-block">
                ...
                <div class="info-item">
                    ...
                    <span class="value">Summer 2023</span>
                </div>
                <div class="info-item">
            ...
            <section class="content-section">
                ...
                <div class="character-grid">
                    ...
                    $characters = getCharactersByAnimeId($con, $anime['id']) ?: [
                        ['name' => 'Yuuji Itadori', 'role' => 'Main', 'image_url' => 'img/itadori-main.webp'],
                        ['name' => 'Satoru Gojo', 'role' => 'Main', 'image_url' => 'img/gojo-main.jpg']
                    ];
