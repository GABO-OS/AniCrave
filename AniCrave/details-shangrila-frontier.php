...
<div class="details-banner"
    style="background-image: url('<?php echo $anime['banner_image'] ?? 'img/shangrila-banner.jpg'; ?>');">
...
<div class="container details-header-container">
    ...
    <div class="details-cover">
        ...
        <img src="<?php echo $anime['cover_image'] ?? 'img/shangrila-frontier.png'; ?>" alt="Shangri-La Frontier Cover">
    ...
    <div class="details-title-section">
        ...
        <p class="description-text">
            Rakuro Hizutome, a high school student who loves nothing more than finding "trash games" and beating the
            absolute crap out of them. His gaming skills are second to none, and no game is too bad for him to
            enjoy.
            <br><br>
            So when he's introduced to the new VRMMORPG Shangri-La Frontier, he does what he does best—min-maxes and
            skips the prologue to jump straight into the action. But can even an expert like Rakuro discover all the
            secrets that Shangri-La Frontier hides?
        </p>
    </div>
</div>
    ...
    <div class="details-body">
        <section class="content-section">
            ...
            <div class="character-grid">
                ...
                $characters = getCharactersByAnimeId($con, $anime['id']) ?: [
                    ['name' => 'Sunraku', 'role' => 'Main', 'image_url' => 'img/sunraku-main.webp'],
                    ['name' => 'Saiga-0', 'role' => 'Main', 'image_url' => 'img/saiga-main.jpg']
                ];
