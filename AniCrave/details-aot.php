<?php
include 'connect.php';
$anime = getAnimeByTitle($con, "Attack on Titan Final Season");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Attack on Titan Final Season - AniCrave</title>
...
<body>
    ...
    <div class="details-banner"
        style="background-image: url('<?php echo $anime['banner_image'] ?? 'img/aot-banner.jpg'; ?>');">
    ...
    <div class="container details-header-container">
        <div class="details-cover">
            <img src="<?php echo $anime['cover_image'] ?? 'img/aot.jpeg'; ?>"
                alt="AoT Cover">
        ...
        <div class="details-title-section">
            ...
            <p class="breadcrumbs">Shingeki no Kyojin: The Final Season</p>
            <p class="description-text">
                The world outside the walls is revealed, and it's far from the paradise the people of Paradis Island
                imagined. As the conflict between the Eldians and the Marleyans reaches its breaking point, Eren Yeager
                embarks on a radical path that will change the fate of both nations forever.
                <br><br>
                This final season follows the descent into chaos as former allies become enemies and once-simple beliefs
                are shattered. The battle for survival transcends walls, and the true nature of the Titans is finally
                unveiled in an epic, world-shaking conclusion.
            </p>
        </div>
    </div>
        ...
        <div class="details-sidebar">
            <div class="info-block">
                ...
                <div class="info-item">
                    ...
                    <span class="value">28+ (Multiple Parts)</span>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <span class="value">Fall 2023 (Final Special)</span>
                </div>
                <div class="info-item">
            ...
            <div class="sidebar-section">
                ...
                <div class="tags-list">
                    ...
                    <span class="tag">Post-Apocalyptic</span>
            ...
            <section class="content-section">
                ...
                <div class="character-grid">
                    ...
                    $characters = getCharactersByAnimeId($con, $anime['id']) ?: [
                        ['name' => 'Eren Yeager', 'role' => 'Main', 'image_url' => 'img/eren-main.jpg'],
                        ['name' => 'Mikasa Ackerman', 'role' => 'Main', 'image_url' => 'img/mikasa-main.jpg']
                    ];
