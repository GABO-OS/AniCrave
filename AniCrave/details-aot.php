...
<div class="details-banner"
    style="background-image: url('<?php echo $anime['banner_image'] ?? 'img/aot-banner.png'; ?>');">
...
<div class="container details-header-container">
    ...
    <div class="details-cover">
        ...
        <img src="<?php echo $anime['cover_image'] ?? 'img/aot.png'; ?>" alt="Attack on Titan Cover">
    ...
    <div class="details-title-section">
        ...
        <p class="description-text">
            <?php echo $anime['description'] ?? 'Gabi, a young soldier of the Marleyan army, is determined to inherit the Armored Titan. As the war between Marley and Paradis reaches its climax, she finds herself caught in the middle of a conflict that challenges everything she has ever believed in.'; ?>
        </p>
    </div>
</div>
    ...
    <div class="details-sidebar">
        <div class="info-block">
            ...
            <div class="info-item">
                ...
                <span class="value">Winter 2022</span>
            </div>
            <div class="info-item">
        ...
        <section class="content-section">
            ...
            <div class="character-grid">
                ...
                $characters = getCharactersByAnimeId($con, $anime['id']) ?: [
                    ...
                    ['name' => 'Mikasa Ackerman', 'role' => 'Main', 'image_url' => 'img/mikasa-main.webp']
                ];
